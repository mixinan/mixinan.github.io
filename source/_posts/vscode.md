---
title: 用VSCode编写C语言程序
date: 2018-06-07 13:49:04
tags: VSCode
categories: 教程
---
VSCode 是微软开发的编辑器。打开速度很快，支持的功能也非常丰富——有各种各样的插件。本篇介绍如何用它编写C语言程序。
...
在 VSCode 里查找文件的功能，困扰了我很久，但一直都懒得去网上搜帖子，全靠眼睛在一堆文件里找。随着文件越来越多，今天我瞪大眼睛找来找去，实在忍无可忍了，终于不得不去百度，才搞清楚：

在 VSCode 里，按 ctrl + p 可以查找文件。它的查找功能相当灵活，字母不区分大小写，甚至字母不相连也能匹配，比如搜“ab”关键字，候选项里也会出现名字是“acdbe.txt”的文件。

按功能键 F1 也可以查找，与它功能一样的，还有个组合键 ctrl + shift + p ，但它们是查找命令的功能，不是查找文件。不过不要紧，在弹出的命令搜索框里，删掉左侧的 > 符号，就会变成查找文件功能了。
